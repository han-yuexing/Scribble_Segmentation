...
#         # -----原本这里没relu-----  deeplabv3+的横向连接
#         x1 = self.relu(x)  # add relu here
#         low_level_feat = x1
#         # -----原本这里没relu-----
...
model_urls = {
    'xception': '/home/liruiqi/.cache/torch/hub/checkpoints/xception-b5690688.pth'  # 'http://data.lip6.fr/cadene/pretrainedmodels/xception-b5690688.pth'
}
...
class Xception(nn.Module):
    ...
    """
    def __init__(self, os, pretrained=True):
        """ Constructor
        Args:
